...
import { View, Pressable, StyleSheet,StatusBar, useWindowDimensions, Platform} from 'react-native';
...
export default function BottomNavigationBar() {
  ...
  return (
    <View style={styles.bottomNavigation}>
      ...
      >
        <Ionicons name="home-outline" size={24} color={activeButton === 'Home' ? 'white' : 'black'} />
      </Pressable>
      <Pressable
      ...
      >
        <Ionicons name="person-outline" size={24} color={activeButton === 'Profile' ? 'white' : 'black'} />
      </Pressable>
      <Pressable
        style={[styles.navButton, activeButton === 'Login' && styles.activeButton]}
        onPress={() => handlePress('Login')}
      >
        <Ionicons name="checkmark-circle-outline" size={24} color={activeButton === 'Login' ? 'white' : 'black'} />
      </Pressable>
      <Pressable
        style={[styles.navButton, activeButton === 'Signup' && styles.activeButton]}
